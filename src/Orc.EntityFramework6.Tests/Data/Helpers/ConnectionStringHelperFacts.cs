...
namespace Orc.EntityFramework.Tests.Data
{
    ...
    public class ConnectionStringHelperFacts
    {
        ...
        public class TheDbContextSetConnectionStringMethod
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => ConnectionStringHelper.SetConnectionString((DbContext)null, "dummy"));
            }
            ...
            public void ThrowsArgumentExceptionForNullOrWhitespaceConnectionString()
            {
                ...
                {
                    Assert.Throws<ArgumentException>(() => ConnectionStringHelper.SetConnectionString(dbContext, null));
                    Assert.Throws<ArgumentException>(() => ConnectionStringHelper.SetConnectionString(dbContext, string.Empty));
                }
            }
        ...
        public class TheObjectContextSetConnectionStringMethod
        {
            ...
            public void ThrowsArgumentExceptionForNullOrWhitespaceConnectionString()
            {
                ...
                {
                    Assert.Throws<ArgumentException>(() => ConnectionStringHelper.SetConnectionString(objectContext, null));
                    Assert.Throws<ArgumentException>(() => ConnectionStringHelper.SetConnectionString(objectContext, string.Empty));
                }
            }
        ...
        public class TheObjectContextGetConnectionStringMethod
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => ConnectionStringHelper.SetConnectionString((ObjectContext)null, "dummy"));
            }
