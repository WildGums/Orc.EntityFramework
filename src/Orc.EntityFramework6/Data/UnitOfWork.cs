namespace Orc.EntityFramework
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(DbContext context, string? tag = null)
        {
            ...
            _typeFactory = _serviceLocator.ResolveRequiredType<ITypeFactory>();
...
#pragma warning restore IDISP003 // Dispose previous before re-assigning.
            ...
            where TEntityRepository : IEntityRepository
        {
            ...
            var repository = _typeFactory.CreateRequiredInstanceWithParameters(registrationInfo.ImplementingType, DbContext);
