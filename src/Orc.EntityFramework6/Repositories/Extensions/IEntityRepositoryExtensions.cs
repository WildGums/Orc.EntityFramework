namespace Orc.EntityFramework
{
    ...
    public static class IEntityRepositoryExtensions
    {
        ...
        /// <param name="predicate">The predicate.</param>
        /// <returns>The entity or <c>null</c> if no entity matches the criteria.</returns>
        public static async Task<TEntity?> SingleOrDefaultAsync<TEntity>(this IEntityRepository<TEntity> repository, Expression<Func<TEntity, bool>>? predicate = null)
            where TEntity : class
        {
            ArgumentNullException.ThrowIfNull(repository);
        ...
        /// <param name="predicate">The predicate.</param>
        /// <returns>The entity or <c>null</c> if no entity matches the criteria.</returns>
        public static async Task<TEntity?> FirstOrDefaultAsync<TEntity>(this IEntityRepository<TEntity> repository, Expression<Func<TEntity, bool>>? predicate = null)
            where TEntity : class
        {
            ArgumentNullException.ThrowIfNull(repository);
